...
import cloud from "../assets/images/update.png";
...
const UpdateOrder = () => {
  ...
  const customStyles = {
    ...
    option: (provided, state) => ({
      ...provided,
      backgroundColor: state.isSelected ? '#grey' : state.isFocused ? '#grey' : null,
      color: 'white',
      '&:hover': {
                ...
                <div className=" h-[750px] w-[1550px] flex justify-center items-center rounded" >
                  <div className="flex h-[630px] w-[1400px] relative z-40 flex-col items-center justify-center p-6 text-slate-400/0 xl:text-slate-400">
                    ...
                    <div className="text-white w-full mx-10">
                      <h1 className="text-md font-semibold moda text-start">Payment Method</h1>
                      ...
                      <div className="col-span-4 row-span-4 bg-grey rounded card flex justify-center items-center">
                        <div className="text-white">
                          <div className="mx-5">
                            <div class="">
                              <label for="address" class="block text-md font-semibold text-white mb-1">Address</label>
                              <input
                                type="text"
                                id="address"
                            ...
                            <div class="">
                              <label for="city" class="block text-md font-semibold text-white mb-1">City</label>
                              <input
                                type="text"
                                id="city"
                                class="w-full rounded border py-2 focus:outline-grey px-3 text-white bg-transparent"
                            ...
                            <div class="grid grid-cols-2 gap-4 ">
                              <div>
                                <label for="state" class="block text-md font-semibold text-white mb-1">State</label>
                                <input
                                  type="text"
                                  id="state"
                                  class="w-full rounded border py-2 focus:outline-grey px-3 text-white bg-transparent"
                              ...
                              <div>
                                <label for="zip" class="block text-md font-semibold text-white mb-1">ZIP Code</label>
                                <input
                                  type="text"
                                  id="zip"
                                  class="w-full rounded border py-2 focus:outline-grey px-3 text-white bg-transparent"
                      ...
                      <div className="col-span-2 row-span-4 bg-grey rounded card flex justify-center items-center">
                        <div className="text-white w-full my-2">
                          <h1 className="text-md font-semibold moda text-center ml-2 mb-2">Profile</h1>
                      ...
                      <button className="col-span-6 row-span-1 bg-teal rounded flex justify-center items-center cursor-pointer" onClick={() => toast('Order Successfully')}>
                        <div className="text-white w-full mx-10">
                      ...
                      <div className="col-span-4 row-span-1 bg-grey rounded card flex justify-center py-3 items-center">
                        <div className="text-white w-full mx-10">
                          <h1 className="text-md font-semibold moda text-start">Quantity</h1>
                          <div className="w-full flex justify-center">
                            <select className="rounded text-center border focus:outline-grey bg-transparent w-full py-2">
                              {[1, 2, 3, 4, 5].map((option) => (
                                <option key={option} className="bg-grey">{option}</option>
                              ))}
                            </select>
                          </div>
                        </div>
