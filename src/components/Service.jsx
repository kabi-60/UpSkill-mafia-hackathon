  ...
  return (
    <section className="pt-20 lg:pt-[120px] pb-12 lg:pb-[90px]">
      <div className="container">
        <div className="flex flex-wrap ">
          <div className="w-full px-4">
            <div className="text-center mx-auto mb-12  ">
              ...
              <p className="text-sm font-bold text-grey w-[55%] mx-auto">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odio
                cum nostrum distinctio quam. Eligendi fugiat eius, porro quae
                doloremque ipsam! Cum porro doloremque quo, eos saepe natus
                eligendi odio? Odio.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-wrap ">
          <div className="w-full md:w-1/2 lg:w-[25%] mx-auto px-4">
            <div
              className="
                  p-10
                  md:px-7
            ...
            >
              ...
              <h4 className="font-semibold text-xl text-dark mb-3">Delevery</h4>
              <p className="text-body-color">
                If the weight of the paper is more than 5Kg we offer you extra
                money for every 5Kgs.
              </p>
            </div>
          </div>
          <div className="w-full md:w-1/2 lg:w-[25%] mx-auto px-4">
            ...
            >
              ...
              <h4 className="font-semibold text-xl text-dark mb-3">
                More Product More Offer
              </h4>
              <p className="text-body-color">
                If you are selling more products we are offering you an discount
                and a cashbackoffer.
              </p>
            </div>
          </div>
          <div className="w-full md:w-1/2 lg:w-[25%] mx-auto px-4">
            ...
            >
              ...
              <p className="text-body-color">
                There are more than 300 shops in our website.All the shops are
                trustable.
              </p>
            </div>
          </div>
