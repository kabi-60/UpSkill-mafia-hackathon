...
const Service = () => {
  return (
    <div className="bg-space my-24">
      <div className="container mx-auto px-4">
        <div className="text-center w-full md:w-[600px] mx-auto">
          <h1 className="mb-6 text-xl text-grey font-extrabold md:text-4xl lg:text-7xl">
            <span className="text-teal">Service</span> We Offer
          </h1>
          <p className="mt-2 font-semibold text-grey">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero
            temporibus eos mollitia eaque. Illo, distinctio sed. Porro
            laboriosam qui explicabo facere, delectus voluptates, amet nostrum
            maiores consequatur modi saepe consectetur!
          </p>
        </div>
        <div className="flex items-center justify-center rounded-lg p-6 text-grey md:p-12">
          <div className="grid gap-12 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center justify-center gap-1 text-center md:items-center md:text-center lg:items-start lg:text-left">
              <svg
